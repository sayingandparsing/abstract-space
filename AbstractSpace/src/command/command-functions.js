...
var CommandExecution = /** @class */ (function () {
    ...
    CommandExecution.prototype.executeCommand = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var cmd;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!cmd)
                            return [2 /*return*/];
                        logger_1.log.debug('Checking command type');
                        if (!(cmd instanceof command_1.ShellCommand)) return [3 /*break*/, 2];
                        logger_1.log.debug('Executing shell command: ');
                        logger_1.log.debug(cmd.cmd);
    ...
    CommandExecution.prototype.executeShellCommand = function (cmd) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
...
//# sourceMappingURL=command-functions.js.map