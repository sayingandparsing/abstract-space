...
var SpaceParser = /** @class */ (function () {
    function SpaceParser(structureDir) {
        ...
        this.getId = function () {
            var id = _this.newCmdId;
            _this.newCmdId++;
            return id;
        };
    }
    SpaceParser.prototype.traverse = function (tree, symbol) {
        return __awaiter(this, void 0, void 0, function () {
            var result, data, subtrees, _i, _a, key, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        key = _a[_i];
                        if (!this.metadataFields.has(key)) return [3 /*break*/, 3];
                        data[key] = tree[key];
                        return [3 /*break*/, 5];
                    case 3:
                        _c = (_b = subtrees).push;
                        return [4 /*yield*/, this.traverse(tree[key], key)];
                    case 4:
                        _c.apply(_b, [_d.sent()]);
                        _d.label = 5;
                    case 5:
    ...
    SpaceParser.prototype.registerCommand = function (command) {
        var id = this.getId();
